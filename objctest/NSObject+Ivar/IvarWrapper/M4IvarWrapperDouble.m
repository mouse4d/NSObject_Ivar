...
@implementation M4IvarWrapperDouble
...
- (NSString*)stringValueWithObject:(id)object {
    ...
    double var = *(double*)((__bridge void*)object + ivar_getOffset(self.ivar));
...
- (NSString *)stringValueWithPointer:(void *)pointer {
    ...
    return [NSString stringWithFormat:@"%e", *(double*)pointer];
}
