...
@implementation M4IvarWrapperLongLong
...
- (NSString*)stringValueWithObject:(id)object {
    ...
    return [NSString stringWithFormat:@"%lld", ((long long (*)(id, Ivar))object_getIvar)(object, self.ivar)];
}
...
- (NSString *)stringValueWithPointer:(void *)pointer {
    ...
    return [NSString stringWithFormat:@"%lld", *(long long *)pointer];
}
