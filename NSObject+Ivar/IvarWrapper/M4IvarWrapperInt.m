...
@implementation M4IvarWrapperInt
...
- (NSString*)stringValueWithObject:(id)object {
    ...
    return [NSString stringWithFormat:@"%d", ((int (*)(id, Ivar))object_getIvar)(object, self.ivar)];
}
...
- (NSString *)stringValueWithPointer:(void *)pointer {
    ...
    return [NSString stringWithFormat:@"%d", *(int*)pointer];
}
