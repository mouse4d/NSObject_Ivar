...
@implementation M4IvarWrapperChar
...
- (NSString *)stringValueWithPointer:(void *)pointer {
    ...
    return [NSString stringWithFormat:@"%hhd", *(char*)pointer];
}

- (NSString*)stringValueWithObject:(id)object {

    return [NSString stringWithFormat:@"%hhd", ((char (*)(id, Ivar))object_getIvar)(object, self.ivar)];
}
