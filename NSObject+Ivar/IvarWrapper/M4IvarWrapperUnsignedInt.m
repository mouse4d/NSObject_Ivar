...
@implementation M4IvarWrapperUnsignedInt
...
- (NSString*)stringValueWithObject:(id)object {
    ...
    return [NSString stringWithFormat:@"%u", ((unsigned int (*)(id, Ivar))object_getIvar)(object, self.ivar)];
}
...
- (NSString *)stringValueWithPointer:(void *)pointer {
    ...
    return [NSString stringWithFormat:@"%u", *(unsigned int*)pointer];
}
